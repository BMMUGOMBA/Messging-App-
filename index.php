<!--
    php code to test is session is set and redirect to login if not set
-->
<?php
session_start();
...
<head>
    ...
    <title><?php echo ucwords(str_replace('_',' ',$page)) ?> |Messaging Web Application || ChatApp</title>
...
//navigation bar bootstrap
    ...
    //gets and displays info by using including page.php
